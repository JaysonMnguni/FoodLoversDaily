...
@section('site-content')
    ...
    <div class="container" style="margin-top: 150px">
        ...
        <div id="page-heading" class="d-flex align-items-center mb-3">
            <h3 class="display-5 main-font">Create a Post</h3>
            ...
            <div class="card-body">
                ...
                <form action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="title" class="form-control form-control-lg bg-light {{ $errors->has('title')? 'is-invalid': ''}}" value="{{old("title")}}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea id="post-body" name="post-body" class="form-control form-control-lg bg-light  {{ $errors->has('post-body')? 'is-invalid': ''}}" id="" cols="30" rows="3">{{old("post-body")}}</textarea>
